...
- [X] T020 [US3] Add `evals/v2` to `config-sweep-exclusions.txt` under the 3.0-wall block: `evals/v2                                         eval-suite-v2: the 2026-09-03 3.0 cut; its four wide exams seat 8/6 cats and predate the roster-width ruling (spec 051); v3 is current` (format: path, then rationale, matching the `evals/v1` line).
