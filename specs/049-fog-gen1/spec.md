...
- **Want law**: armed AND top need AND no known relief (elements: visible or remembered; social kinds: an idle friend in view — heard friends never gate); the one predicate the mask and the built-in announce share.
