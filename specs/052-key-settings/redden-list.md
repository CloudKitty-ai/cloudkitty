...
FINAL count (T023, 2026-09-09): **905 / 0, 6 ignored** = cycle 0 + the 8 new tests (6 unit in `settings.rs`, 2 integration); fmt + clippy clean; the four shell tests exit 0. After the review round and the merge of origin/main (784de6f): **906 / 0, 6 ignored** (+ `f32_dials_print_as_written`); CI green at 4d5ba51 with the Shell-tests step.
