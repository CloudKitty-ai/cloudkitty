...
- [x] T027 Flag the two comment-only hunks (client/render.js stale easing comment, client/app.js stale targetFor reference) in the 038 PR body per plan: render.js zero-diff constraint (partial)
