...
- [ ] T001 Baseline: `cargo test --workspace --release` green at the
      branch point (040-welfare-watchdog off main e39079e)

## Phase 2: Foundational

- [ ] T002 `WatchdogConfig` in crates/cloudkitty-server/src/watchdog.rs:
...
- [ ] T003 [US1] Red-first alarm tests in watchdog.rs: synthetic
...
- [ ] T004 [US1] Implement `Watchdog::observe(&World) ->
...
- [ ] T005 [US1] Wire the serving path in sim_task.rs + main.rs:
...
- [ ] T006 [US2] `GET /welfare` in lib.rs + api.rs serving the latest
...
- [ ] T007 [P] cloudkitty.toml gains the documented `[watchdog]`
...
- [ ] T008 Full gate: workspace suite (read the count) + clippy
